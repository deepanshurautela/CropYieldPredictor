...
API2PDF_API_KEY = '73f12bd4-b1cb-47ae-af01-8a7eed124a10' # get key from portal.api2pdf.com/register
USERAGENT = {
...
def make_pdf_from_url(url, options=None):
    ...
    print(pdf_response.result)
    if pdf_response.result['success']:
        return pdf_response.result['pdf']
    else:
        return None
